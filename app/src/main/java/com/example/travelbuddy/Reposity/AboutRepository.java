...
public class AboutRepository {
    ...
    if (Locale.getDefault().getLanguage().equals("da")) {
        ...
        aboutList.add(new About("Dette er rasmus. Han er 25 år gammel og arbejder som vicevært", R.drawable.pickle));
        ...
        aboutList.add(new About("This is rasmus. He is 25 years old. He is in charge of all pickles.", R.drawable.pickle));
